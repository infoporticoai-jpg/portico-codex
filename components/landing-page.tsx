...
export function LandingPage() {
  ...
  return <>
    ...
    <section id="pricing" className="section"><div className="shell"><div className="section-head reveal"><span className="eyebrow">Pricing</span><h2>Pay for the call volume you need.</h2><p>Usage-based pricing that scales with you — no setup fee, cancel anytime. <a href="/pricing">Full pricing details →</a></p></div><PricingPlans /></div></section>

    <section id="faq" className="section soft"><div className="shell"><div className="section-head reveal"><span className="eyebrow">Questions, answered</span><h2>Everything you need to know.</h2></div><Faq /><div className="sol-foot reveal"><p><a href="/faq">See the full FAQ →</a></p></div></div></section>
