...
const INDUSTRIES: Industry[] = [
  ...
  { id: "hvac", label: "HVAC",
    overview: "Capture every service call, day or night, and get technicians dispatched fast — no lead left on voicemail.",
    callTypes: ["Emergency no-heat / no-cool", "Service scheduling", "Quotes & estimates", "Maintenance reminders", "After-hours dispatch"],
