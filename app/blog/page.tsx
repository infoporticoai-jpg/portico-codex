...
const posts: { cat: string; title: string; excerpt: string; read: string }[] = [
  ...
  { cat: "HVAC", title: "Turning emergency service calls into same-day dispatch", excerpt: "Capture the details, priority-flag the no-heat calls, and get a technician on the way — automatically.", read: "5 min read" },
